...
REFERENCE_A = "reference_a_trend_square_bracket_no_regime"
REFERENCE_B = "reference_b_trend_square_bracket_regime_tl"
...
def run_reference(
    ...
    *,
    ...
    data = build_regime_tl_execution_data(prepared, parsed)
...
def run_public_reference(reference_id: str, *, warmup_bars: int = 1000):
    ...
    return S06RTrendV02RegimeTLB2.run(prepared, params, trade_start_idx=trade_start_idx)
