"""S03 Reversal v10 fast Grid backend.
...
FLOAT_PARAMS = {"maOffset3", "tBandLongPct", "tBandShortPct", "contractSize", "initialCapital", "commissionPct"}
INT_PARAMS = {"maLength3", "closeCountLong", "closeCountShort"}
BOOL_PARAMS = {"useCloseCount", "useTBands", "dateFilter"}
