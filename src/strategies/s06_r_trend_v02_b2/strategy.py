...
def build_v2_execution_data(df: pd.DataFrame, params: Mapping[str, Any]) -> ExecutionData:
    """Build the S06 B2 V2 execution arrays for generic Grid V2."""

    parsed = S06B2Params.from_dict(normalized_params(dict(params or {})))
    ...
    return build_s06_b2_execution_data(df, parsed)
